...
def add_args(parser):
    ...
    parser.add_argument("--num_layers", type=int, default=4, help="Number of STLLM7 layers")
    parser.add_argument("--d_pm", type=int, default=16, help="Per-mode embedding dim")
    parser.add_argument("--mode_hidden_dim", type=int, default=16, help="Hidden size for dynamic correlation graph")
