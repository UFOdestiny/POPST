...
from stgcn_gaussian_engine import STGCN_Gaussian_Engine
import torch

torch.set_num_threads(8)

from src.flow.stgcn.stgcn_model import STGCN_Gaussian
...
from base.metrics import normal_loss
...
def main():
    ...
    model = STGCN_Gaussian(node_num=node_num,
    ...
    engine = STGCN_Gaussian_Engine(device=device,
                                   model=model,
