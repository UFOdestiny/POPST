...
def add_args(parser):
    ...
    parser.add_argument("--mode_attn_heads", type=int, default=2, help="Cross-mode attention heads")
    parser.add_argument("--mode_attn_dim", type=int, default=16, help="(unused; kept for backward-compat)")
...
def build_model(args, node_num, **ctx):
    return STLLM(
        ...
        d_pm=args.d_pm,
        mode_attn_heads=args.mode_attn_heads,
